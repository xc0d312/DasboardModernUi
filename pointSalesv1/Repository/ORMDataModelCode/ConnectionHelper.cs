...
namespace pointSalesv1.Models.puntoVenta
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(categoria),
            typeof(clientes),
            typeof(codigocategorias),
            typeof(codigomarcas),
            typeof(codigoproducto),
            typeof(codigoproveedores),
            typeof(codigoventa),
            typeof(detalle_entrada),
            typeof(detalle_perdida),
        ...
        public static string ConnectionString { get { return System.Configuration.ConfigurationManager.ConnectionStrings["localhostpuntoVenta"].ConnectionString; } }
